...
const Layout_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $page.route.id;
  $$unsubscribe_page();
  return `<main><div class="${"sidenav svelte-8ege"}"><ul class="${"svelte-8ege"}"><li><a href="${"/"}" class="${"btn active svelte-8ege"}">Dashboard</a></li>
			<li><a href="${"/MyCurriculum"}" class="${"btn inactive svelte-8ege"}">My Curriculum</a></li>
			<li><a href="${"/Grades"}" class="${"btn inactive svelte-8ege"}">Grades</a></li>
