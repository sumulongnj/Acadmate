...
<main>
	<div class="sidenav">
		<ul>
			...
			<li>
				<a href="/MyCurriculum" class="btn active">
					<img src="/curriculum.svg" alt="curriculum" class="icon current">
					My Curriculum
				</a>
			</li>
			<li>
			...
			<li>
				<a href="/Requirements" class="btn inactive">
					<img src="/requirement.svg" alt="requirement" class="icon">
					Requirements
				</a>
			</li>
		</ul>
